...
with open('ClavePrivada1.pem','w') as pr1:
    pr1.write(str(private_key))
with open('ClavePublica1.pem','w') as pub1:
    pub1.write(str(public_key))
    
#clave 2
private_key2 = RSA.generate(1024, random_generator)
public_key2 = private_key2.public_key()
    
private_key2 = private_key2.exportKey(format='DER')
public_key2 = public_key2.exportKey(format='DER')
    
private_key2 = binascii.hexlify(private_key2).decode('utf-8')
public_key2 = binascii.hexlify(public_key2).decode('utf-8')
    
private_key2 = RSA.importKey(binascii.unhexlify(private_key2))
public_key2 = RSA.importKey(binascii.unhexlify(public_key2))

with open('ClavePrivada2.pem','w') as pr2:
    pr2.write(str(private_key2))
with open('ClavePublica2.pem','w') as pub2:
    pub2.write(str(public_key2))
#clave 3
private_key3 = RSA.generate(1024, random_generator)
public_key3 = private_key3.public_key()
    
private_key3 = private_key3.exportKey(format='DER')
public_key3 = public_key3.exportKey(format='DER')
    
private_key3 = binascii.hexlify(private_key3).decode('utf-8')
public_key3 = binascii.hexlify(public_key3).decode('utf-8')
    
private_key3 = RSA.importKey(binascii.unhexlify(private_key3))
public_key3 = RSA.importKey(binascii.unhexlify(public_key3))

with open('ClavePrivada3.pem','w') as pr3:
    pr3.write(str(private_key3))
...
while respuesta == 'Si' or respuesta == 'si':
    ...
    if opcion == '2':
        ...
        if clave_elejir == '1':
            ...
            cipher = PKCS1_OAEP.new(private_key2)
            ...
            cipher = PKCS1_OAEP.new(private_key3)
